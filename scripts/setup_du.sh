...
ensure_module "$CUSTOM_YANG_DIR/nrcelldu-pusch-extensions.yang"
ensure_module "$CUSTOM_YANG_DIR/nrcelldu-pucch-extensions.yang"
ensure_module "$CUSTOM_YANG_DIR/nrcelldu-pdcch-extensions.yang"
ensure_module "$CUSTOM_YANG_DIR/nrcelldu-csi-extensions.yang"
ensure_module "$CUSTOM_YANG_DIR/nrcelldu-srs-extensions.yang"
...
ensure_module "$CUSTOM_YANG_DIR/nrcelldu-mac-cell-group-extensions.yang"
ensure_module "$CUSTOM_YANG_DIR/nrcelldu-sib-extensions.yang"
ensure_module "$CUSTOM_YANG_DIR/nrcelldu-paging-extensions.yang"
ensure_module "$CUSTOM_YANG_DIR/nrcelldu-drx-extensions.yang"
...
ensure_module "$CUSTOM_YANG_DIR/rudummy-extensions.yang"
ensure_module "$CUSTOM_YANG_DIR/rusdr-extensions.yang"
